...
// правая часть
    ...
    expensesBlock: function () {
      ...
      appData.inputTextCheck(expensesItems[expensesItems.length-1].querySelector('.expenses-title'));
      appData.inputFigureCheck(expensesItems[expensesItems.length-1].querySelector('.expenses-amount'));
  },
    incomeBlock: function () {
      ...
      appData.inputTextCheck(incomeItems[incomeItems.length-1].querySelector('.income-title'));
      appData.inputFigureCheck(incomeItems[incomeItems.length-1].querySelector('.income-amount'));
    },
...
const figureItems=( document.querySelectorAll('input[placeholder="Сумма"]'));
for (let item of figureItems) {
  appData.inputFigureCheck (item);
};
